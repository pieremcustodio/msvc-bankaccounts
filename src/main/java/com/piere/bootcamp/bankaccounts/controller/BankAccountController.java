...
public class BankAccountController {
     ...
     */
    @ApiOperation(value = "Check balance of a bank account", nickname = "checkBalance", notes = "Check balance of a bank account", tags = {
            "bankaccounts" })
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Balance consultado") })
    @GetMapping(value = "/checkbalance/{id}", produces = { "application/json" })
    Mono<ResponseEntity<BankAccountDto>> checkBalance(
            @ApiParam(value = "ID of the bank account", required = true) @PathVariable("id") String id) {
     ...
     */
    @ApiOperation(value = "Opening an account bank", nickname = "create", notes = "Opening a new account bank", response = BankAccountDto.class, tags = {
            "bankaccounts", })
    @ApiResponses(value = {
    ...
    Mono<ResponseEntity<BankAccountDto>> createBankAccount(
            @ApiParam(value = "", required = true) @Valid @RequestBody BankAccountDto bankAccountDto) {
     ...
     */
    @ApiOperation(value = "Delete an account bank", nickname = "delete", notes = "Delete an existing account bank", response = BankAccountDto.class, tags = {
            "bankaccounts", })
    @ApiResponses(value = {
     ...
     *         or Not found (status code 404)
     */
    @ApiOperation(value = "Update an account bank", nickname = "update", notes = "Update an existing account bank", response = BankAccountDto.class, tags = {
            "bankaccounts", })
    @ApiResponses(value = {
    ...
    Mono<ResponseEntity<BankAccountDto>> update(
            @ApiParam(value = "", required = true) @Valid @RequestBody BankAccountDto bankAccountDto) {
     ...
     */
    @ApiOperation(value = "Withdraw from a bank account", nickname = "withdraw", notes = "Withdraw from a bank account", response = BankAccountDto.class, tags = {
            "bankaccounts", })
    @ApiResponses(value = {
    ...
    Mono<ResponseEntity<BankAccountDto>> withdraw(
            @ApiParam(value = "ID of the bank account", required = true) @PathVariable String id,
     ...
     */
    @ApiOperation(value = "Deposit to a bank account", nickname = "deposit", notes = "Deposit to a bank account", response = BankAccountDto.class, tags = {
            "bankaccounts", })
    @ApiResponses(value = {
    ...
    Mono<ResponseEntity<BankAccountDto>> deposit(
            @ApiParam(value = "Id of the bank account", required = true) @PathVariable("id") String id,
            @ApiParam(value = "", required = true) @Valid @RequestBody OperationDto operationDto) {
     ...
     */
    @ApiOperation(value = "Get all account banks", nickname = "findAllBankAccounts", notes = "Use to request all account banks", response = BankAccountDto.class, responseContainer = "List", tags = {
            "bankaccounts", })
    @ApiResponses(value = {
